...
describe('favourite blog', () => {
  test('when list has many blogs, equals the blog with most likes', () => {
    assert.deepStrictEqual(listHelper.favouriteBlog(listWithManyBlogs), {
      _id: "5a422b3a1b54a676234d17f9",
      title: "Canonical string reduction",
      author: "Edsger W. Dijkstra",
      url: "http://www.cs.utexas.edu/~EWD/transcriptions/EWD08xx/EWD808.html",
...
describe('most blogs', () => {
  test('when list has many blogs, equals the author with most blogs', () => {
    assert.deepStrictEqual(listHelper.mostBlogs(listWithManyBlogs), {author: "Robert C. Martin", count: 3})
  })
})
